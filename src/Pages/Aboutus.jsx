  ...
  return (
    ...
    <hr className="mb-0"/>
      ...
      <Col xs={12} md={8}>
        ...
        <h5>ISE-1</h5>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni, odit animi cum neque consectetur quibusdam minima quae harum fugit. Mollitia, rerum. Corporis natus, sit temporibus itaque dolorum aperiam sint quod!</p>
